...
public class FragmentECGList extends AppCompatActivity {

    public static final String TAG="FragmentECGList";
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        mUtility = new Utility(FragmentECGList.this);
        mStringSelectedDate = mUtility.getDate();

        mDbHelper = new DBHelper(FragmentECGList.this);
        ...
        mRecyclerViewBPMList.addOnItemTouchListener(new RecyclerItemClickListener(FragmentECGList.this, mRecyclerViewBPMList,
                new RecyclerItemClickListener.OnItemClickListener() {
                    @Override
                    public void onItemClick(View view, int position) {

                        Intent mIntent = new Intent(FragmentECGList.this, FragmentECGDetails.class);
    ...
    public void openDatePickerDialog() {
        ...
        DatePickerDialog datePickerDialog = new DatePickerDialog(FragmentECGList.this, R.style.DialogTheme,
    ...
    public class MyBpmAdpter extends RecyclerView.Adapter<FragmentECGList.MyBpmAdpter.ViewHolder> {

        @Override
        public FragmentECGList.MyBpmAdpter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {

            View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.row_bpm_data_list, parent, false);
            return new FragmentECGList.MyBpmAdpter.ViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(FragmentECGList.MyBpmAdpter.ViewHolder holder, final int position) {

            if (mArrayListVoBPMListData.get(position) != null) {

                holder.mTextViewName.setText(getResources().getString(R.string.tital_ecg_activity));
